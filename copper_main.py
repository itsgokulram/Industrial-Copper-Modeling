...
class prediction:
    ...
    def regression():
        ...
        if button:
            ...
            with open(r'/Users/gokul/My Apple/vs_code_practice/copper_model/regression_model_fl.pkl', 'rb') as f:
                model = pickle.load(f)
    ...
    def classification():
        ...
        if button:
            ...
            with open(r'/Users/gokul/My Apple/vs_code_practice/copper_model/classification_model_fl.pkl', 'rb') as f:
                model = pickle.load(f)
...
with tab1:
    ...
    try:
        ...
        if status == 1:
            ...
            st.markdown(f"<h3 style='text-align: center; color: green;'>Predicted Status = Won</h3>", unsafe_allow_html=True)
            

        elif status == 0:
            
            st.markdown(f"<h3 style='text-align: center; color: red;'>Predicted Status = Lost</h3>", unsafe_allow_html=True)
...
with tab2:
    ...
    try:
        ...
        if selling_price:
            ...
            st.markdown(f"<h3 style='text-align: center; color: blue;'>Predicted Selling Price = {selling_price}</h3>", unsafe_allow_html=True)
